...
def convert_roberta_to_lf():
    ...
    roberta_model = AutoModelForMaskedLM.from_pretrained(ROBERTA_CHECKPOINT, use_auth_token=AUTH_KEY)
    tokenizer = AutoTokenizer.from_pretrained(ROBERTA_CHECKPOINT, use_auth_token=AUTH_KEY,
